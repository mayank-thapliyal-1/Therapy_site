...
const Intro = () => {
  return (
    <div className="flex  sm:flex-row flex-col-reverse justify-around sm:h-screen items-center font-mont bg-accent gap-4 sm:p-4 p-5 h-full ">
      <div className="flex-1 h-full flex flex-col sm:gap-10 gap-5 justify-center items-center sm:px-20">
        <div className="flex flex-col justify-around sm:gap-7 gap-5 p-5">
          <motion.h1
          {...slideInView()}
      ...
      <div className="flex-1  flex  sm:flex-col flex-row items-center sm:h-full  overflow-hidden  sm:w-full w-screen sm:py-10 sm:p-5">
        <motion.div
          {...slideInView()}
        >
          <Image
